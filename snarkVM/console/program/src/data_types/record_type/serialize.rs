...
impl<N: Network> Serialize for RecordType<N> {
...
impl<'de, N: Network> Deserialize<'de> for RecordType<N> {
...
mod tests {
    ...
    fn test_serde_json() {
        for case in TEST_CASES.iter() {
            check_serde_json(RecordType::<CurrentNetwork>::from_str(case).unwrap());
        }
    }
    ...
    fn test_bincode() {
        for case in TEST_CASES.iter() {
            check_bincode(RecordType::<CurrentNetwork>::from_str(case).unwrap());
        }
    }
}
